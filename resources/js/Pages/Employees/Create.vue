...
// Pre-select company from preselectedBranch
if (props.preselectedBranch) {
    const branch = props.branches.find(b => b.id === props.preselectedBranch)
    if (branch) selectedCompany.value = branch.company_id
}
...
const form = useForm({
    branch_id:       props.preselectedBranch ?? '',
    first_name:      '',
    last_name:       '',
    employee_number: '',
    avatar:          '',
    ...
    <AppLayout>
        <div class="max-w-xl">
            <div class="flex items-center gap-4 mb-6">
                ...
                <h1 class="text-xl font-bold text-gray-800 dark:text-gray-100">New Employee</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        class="w-full border border-gray-300 dark:border-gray-600 rounded px-3 py-2 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-50 dark:disabled:bg-gray-600"
                    >
